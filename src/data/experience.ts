...
personalDescription += 'Open Source Projects <a href="https://github.com/surgeharb" target="_blank">GitHub</a> and <a href="https://www.npmjs.com/~surgeh" target="_blank">npm</a>.<br>';
personalDescription += '<a href="http://fitterbite.com/" target="_blank">Fitterbite</a> Application Backend Development and Server Management.<br>';
personalDescription += '<a href="https://movies.sergeharb.com/" target="_blank">Open Movies</a> Open Source Progressive Web App perfectly built with Angular<br>';
...
export const EducationExperience = [
  ...
  {
    position: "Lycee Amchit School",
    location: "Amchit, Lebanon",
    year: "2000 - 2015",
    description: "Lebanese Baccalaureate II in General Science.."
  }
];